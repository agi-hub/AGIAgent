...
def example_basic_usage():
    ...
    response = client.chat(
        ...
        dir="output_calculator_project",  # Output directory
...
def example_with_continue_mode():
    ...
    if response1["success"]:
        ...
        response2 = client.chat(
            ...
            dir="output_my_web_app",  # Same directory
...
def example_with_custom_mcp_and_prompts():
    ...
    response = client.chat(
        ...
        dir="output_ml_pipeline_project"
    )
...
def example_thy_test_project():
    ...
    response = client.chat(
        ...
        dir="output_thy_test_project29",  # Output directory
        loops=100  # Maximum execution rounds
    )
