...
"""
    ...
    def save_execution_report(self, report: Dict[str, Any]):
        ...
        try:
            ...
            print(f"📝 Execution report saved to: {markdown_file}")
            ...
            if get_summary_report():
                try:
                    ...
                    print(f"⚠️ Failed to generate summary report: {e}")
            else:
...
"""
    ...
    def _generate_summary_report_zh(self, report: Dict[str, Any], timestamp: str):
        ...
        try:
            ...
            print(f"📋 任务总结报告已保存到: {summary_file}")
            
        except Exception as e:
            print(f"⚠️ 生成总结报告失败: {e}")
    ...
    def _generate_summary_report_en(self, report: Dict[str, Any], timestamp: str):
        ...
        try:
            ...
            print("🧠 Using large model to generate task summary report...")
            ...
            print(f"📋 Task summary report saved to: {summary_file}")
