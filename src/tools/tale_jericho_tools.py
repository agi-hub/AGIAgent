...
# -*- coding: utf-8 -*-
"""
Single-action TALE-Suite tool implementation for dataset: jericho
"""
...
class TaleJerichoTools:
    DATASET_KEY = "jericho"
    TOOL_PREFIX = "tale_jericho"
    ...
    def tale_jericho_list_tasks(self, tale_suite_root: Optional[str] = None) -> Dict[str, Any]:
